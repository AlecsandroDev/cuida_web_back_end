...
export default function ItemSidebarMap({ id, name, dosage, quantity, tipo, interests, description, handleMedicationInterest, handleDetail, requiresPrescription, foto_url }: any) {
    return (
        <div key={id}         
